    ...
    <>
      ...
      <main className="bg-surface pb-24 pt-32 font-body-md text-on-surface selection:bg-primary-container/30">
        <header className="mx-auto mb-20 max-w-360 px-6 text-center md:px-12">
          <span className="mb-4 block font-label-md uppercase tracking-[0.3em] text-primary reveal-up">The Visual Experience</span>
          <h1 className="mb-6 font-headline-xl text-on-surface reveal-up reveal-stagger-1">Atmospheric Elegance</h1>
          <p className="mx-auto max-w-2xl font-body-lg text-on-surface-variant reveal-up reveal-stagger-2">Explore the interplay of moonlight, verdant life, and culinary artistry. Each frame captures the soul of Botanica Garden-a sanctuary of quiet luxury.</p>
        </header>
        ...
        <section className="mx-auto mt-32 max-w-360 px-6 md:px-12">
          <div className="flex flex-col items-center justify-between gap-12 rounded-xl border border-primary/10 bg-surface-container-low p-10 copper-glow glass-panel md:flex-row md:p-16" data-reveal>
            <div className="max-w-xl">
              <h2 className="mb-6 font-headline-lg text-white reveal-up">Immersive Detail</h2>
              <p className="mb-8 font-body-lg text-on-surface-variant reveal-up reveal-stagger-1">Select any image to enter our high-fidelity lightbox viewer. Experience every texture of our hand-carved stone walls and the intricate garnishing of our signature dishes in stunning 4K clarity.</p>
              <div className="flex flex-wrap gap-6 reveal-up reveal-stagger-2"><div className="flex items-center gap-2 font-label-md uppercase tracking-wider text-primary"><span className="material-symbols-outlined">zoom_in</span>Interactive Viewing</div><div className="flex items-center gap-2 font-label-md uppercase tracking-wider text-primary md:ml-6"><span className="material-symbols-outlined">auto_awesome</span>High Fidelity</div></div>
            </div>
            <div className="relative aspect-video w-full overflow-hidden rounded-lg border border-primary/20 bg-surface-container md:w-1/3 reveal-up reveal-stagger-3"><div className="absolute inset-0 flex items-center justify-center"><span className="material-symbols-outlined text-6xl text-primary/30">play_circle</span></div><SiteImage alt="Virtual Tour Preview" className="h-full w-full object-cover opacity-30 grayscale" src="https://lh3.googleusercontent.com/aida-public/AB6AXuAI478TurovUix4cQ7-Ka_r0mxn7XWN04wlQZKrLZhY0CT2o1O16KW49OZWwPinYYsXGfHp35X72NeaFWmwqf57hBmbzSMzzK0a9CeB0v0gdqmknN40X2CD6tOZXbxZckzSZ5AC7wLhq9MGtaBhcuBuH2co78V-zygsADaf4sdYHcOdleHP9eJ5KjO1UU2qTXxnSrmp1sHPS6KEvRSYtV00-k8wR9RmD7nFJuUf5Y6ltWVxgrblKsSYr8laGlAbSWeDRXfQCZGkOug" /></div>
          </div>
        </section>
      </main>
